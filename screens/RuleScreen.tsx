...
export default function RuleScreen({ navigation, props }: any) {
  ...
  const _getMachines = async () => {
    ...
    const config = {
      method: "get",
      url: APIConfig["api"]["get_machine"].replace("{owner_id}", `${owner_id}`),
      headers: {},
    };
  ...
  const onEditing = () => {
    ...
    navigation.setOptions({
      headerLeft: () => (
        <Ionicons
          size={30}
          name={editing ? "checkmark-outline" : "ios-create-outline"}
          color="#fff"
          onPress={onEditing}
        />
  ...
  const createOrUpdateRule = async () => {
    ...
    var config = {
      method: "post",
      url: ruleID
        ? APIConfig["api"]["update_rule"]
        : APIConfig["api"]["create_rule"],
      headers: {
          ...
          <View style={styles.container}>
            <View style={[styles.threadContainer, { margin: 0 }]}>
              <RuleList
                ...
                key={[editing, refreshing, ruleForm]}
                ruleForm={ruleForm}
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={styles.centeredView}>
            ...
            >
              ...
              <Pressable onPress={() => createOrUpdateRule()}>
                ...
                <View style={{ margin: 5 }}>
                  ...
                  >
                    ...
                    >
                      <TouchableOpacity
                        onPress={() =>
                          setEpxr(selectedExpr === ">=" ? "<=" : ">=")
                        }
                      >
                        <View
                          style={{ borderRadius: 10, padding: 10, flexGrow: 1 }}
                        >
                          <Text
                            style={{
                              color: "gray",
                  ...
                  <View
                    style={[{ marginTop: 15, borderRadius: 7, padding: 10 }]}
                  >
                    <TouchableOpacity disabled={true}>
                      <View
                        style={{
