...
export default function LoginScreen({
  ...
  const _login = async () => {
    if (password === "") {
      Alert.alert("Có lỗi xảy ra", "Bạn chưa nhập mật khẩu", [
    ...
    axios(config)
      ...
      .catch(function (error: any) {
        ...
        Alert.alert("Có lỗi xảy ra", "Đăng nhập không thành công", [
          { text: "OK", onPress: () => console.log("OK Pressed") },
        ]);
      });
  };
  ...
  return (
    <View style={styles.container}>
      <View style={{ width: "100%", justifyContent: "space-around" }}>
        <Text style={{ marginVertical: 7, fontSize: 56, fontWeight: "500" }}>
          Welcome
        </Text>
        ...
        >
          <Text style={{ fontWeight: "500", marginVertical: 7, fontSize: 15 }}>
            Email/Username
          </Text>
