    ...
    >
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color, focused }) => (
            <TabBarIcon
              name={focused ? "ios-water" : "ios-water-outline"}
              color={color}
            />
          ),
        }}
      ...
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color, focused }) => (
            <TabBarIcon
              name={focused ? "ios-radio" : "ios-radio-outline"}
              color={color}
            />
          ),
        }}
  ...
  return (
    <MachineStack.Navigator
      screenOptions={{
        ...
        headerBackground: () => <GradientHeaderTitle />,
  ...
  return (
    ...
    >
      <SensorStack.Screen
        ...
        options={{
          headerTitle: "Danh sách cảm biến",
          headerStyle: styles.container,
          headerTitleAlign: "center",
  ...
  return (
    ...
    >
      <RuleStack.Screen
        ...
        options={{
          headerTitle: "Danh sách điều kiện chạy",
          headerStyle: styles.container,
          headerTitleAlign: "center",
